...
set_false_path -from [get_cells {virtual_top.minimig.cpu_config_reg*}]
set_false_path -from [get_cells {virtual_top.minimig.AGNUS1.bc1.beamcon0_reg*}]
set_false_path -from [get_cells {virtual_top.tg68_rst_sync}]
