...
entity amiga_clk_lattice_pll is
port (
  areset : in std_logic;
  inclk0 : in std_logic;
  c0 : out std_logic;
...
architecture rtl of amiga_clk_lattice_pll is
...
begin
  ...
  (
      ...
      out1_Hz => natural( 28.57e6 ), out1_deg => 0, out1_tol_hz => 1e4,
      out2_Hz => natural( 28.57e6 ), out2_deg => 0, out2_tol_hz => 1e4,
      out3_Hz => natural(142.85e6 ), out3_deg => 0, out3_tol_hz => 1e4
