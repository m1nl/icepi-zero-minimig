...
) auxiliary_video_information_info_frame(.video_id_code(video_id_code), .header(headers[3]), .sub_0(subs[3][0]), .sub_1(subs[3][1]), .sub_2(subs[3][2]), .sub_3(subs[3][3]));
